...
RVInst::RVInst(rid_t rd, rid_t rs1, rid_t rs2, rid_t rs3)
    : dst(rd), src1(rs1), src2(rs2), src3(rs3), stat(nonstr), statlen(0), comt_(COMMENT_BEGIN "error inst") {
...
RVCNAM(LEA$)(rid_t rd, cstr sym) : RVInst(rd) {
    ...
    fprintf(out, TAB "addi    " TAB "%s" COMMA "%s" COMMA "%%lo(%s)", rgnm[rd], rgnm[rd], sym);
    fflush(out);
    fclose(out);
...
RVCNAM(FMADD_S)
(rid_t frd, rid_t frs1, rid_t frs2, rid_t frs3) : RVInst(frd, frs1, frs2, frs3) {
    GENSTAT("fmadd.s" TAB "%s" COMMA "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2], rgnm[frs3]);
...
RVCNAM(FMSUB_S)
(rid_t frd, rid_t frs1, rid_t frs2, rid_t frs3) : RVInst(frd, frs1, frs2, frs3) {
    GENSTAT("fmsub.s" TAB "%s" COMMA "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2], rgnm[frs3]);
...
RVCNAM(FNMADD_S)
(rid_t frd, rid_t frs1, rid_t frs2, rid_t frs3) : RVInst(frd, frs1, frs2, frs3) {
    GENSTAT("fnmadd.s" TAB "%s" COMMA "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2], rgnm[frs3]);
...
RVCNAM(FNMSUB_S)
(rid_t frd, rid_t frs1, rid_t frs2, rid_t frs3) : RVInst(frd, frs1, frs2, frs3) {
    GENSTAT("fnmsub.s" TAB "%s" COMMA "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2], rgnm[frs3]);
...
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fadd.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FSUB_S)
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fsub.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FMUL_S)
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fmul.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FDIV_S)
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fdiv.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FSGNJ_S)
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fsgnj.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FSGNJN_S)
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fsgnjn.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FSGNJX_S)
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fsgnjx.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FMIN_S)
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fmin.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FMAX_S)
(rid_t frd, rid_t frs1, rid_t frs2) : RVInst(frd, frs1, frs2) {
    GENSTAT("fmax.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[frd], rgnm[frs1], rgnm[frs2]);
...
(rid_t rd, rid_t frs1, rid_t frs2) : RVInst(rd, frs1, frs2) {
    GENSTAT("feq.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[rd], rgnm[frs1], rgnm[frs2]);
...
RVCNAM(FLT_S)
(rid_t rd, rid_t frs1, rid_t frs2) : RVInst(rd, frs1, frs2) {
    GENSTAT("fmin.s" TAB "%s" COMMA "%s" COMMA "%s", rgnm[rd], rgnm[frs1], rgnm[frs2]);
