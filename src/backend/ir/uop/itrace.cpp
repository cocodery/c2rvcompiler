...
void uop_set_iparam::trace_inst() {
    rs_->add_ref(this);
}

void uop_set_fparam::trace_inst() {
    rs_->add_ref(this);
}

void uop_call::trace_inst() {
    if (retval_)
        retval_->set_from(this);
}

void uop_li::trace_inst() {
    rd_->set_from(this);
}
...
void uop_la::trace_inst() {
    rd_->set_from(this);
}

void uop_lla::trace_inst() {
    rd_->set_from(this);
}
...
void uop_ld_l::trace_inst() {
    rd_->set_from(this);
}

void uop_st_l::trace_inst() {
    rd_->add_ref(this);
}
...
void uop_fld_l::trace_inst() {
    rd_->set_from(this);
}

void uop_fst_l::trace_inst() {
    rd_->add_ref(this);
}

void uop_fld_ll::trace_inst() {
    rd_->set_from(this);
}
